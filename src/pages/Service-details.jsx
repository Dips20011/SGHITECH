  ...
  return (
   ...
   <div className="page-title accent-background">
      <div className="container r">
        <h1 className="mb-2 mb-lg-0 text-center">Service-Details</h1>
      ...
      <div className="container">
        ...
        <div className="row gy-4">
          ...
          <div className="col-lg-8" >
            <img src="src/assets/img/hero-carousel/pexels-tima-miroshnichenko-5439483.jpg" alt="" className="img-fluid services-img"/>
